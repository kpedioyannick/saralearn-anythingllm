...
const { saraEndpoints } = require("./endpoints/sara");
...
const { router: userExercisesRouter } = require("./endpoints/userExercises");
...
apiRouter.use("/v1/user/exercises", userExercisesRouter);
