const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    followup_chips: {
      ...
      fiche: { label: "Lesson", template: "Make me a study sheet on this topic" },
      exercice: { label: "Exercises", template: "Give me exercises on this topic" },
      ...
      coach_demain: { label: "Tomorrow?", template: "What about tomorrow?" },
      coach_detail: { label: "Details", template: "Break it down by chapter or subject" },
      coach_encore: { label: "More", template: "Keep going, motivate me" },
      coach_action: { label: "Next step", template: "What is my next concrete action?" },
    },
    sources: "Sources",
  ...
  sara: {
    quiz: {
      ...
      validate: "Validate",
      correct: "Correct!",
      wrong_answer: "Correct answer: {{answer}}",
      wrong_vf: "Answer: {{answer}}",
      placeholder_short: "Short answer...",
      placeholder_write: "Write your answer here…",
      i_knew: "I knew it!",
      well_done: "Well done!",
      keep_revising: "Keep revising!",
      score_perfect: "Perfect!",
      score_good: "Well done!",
      score_keep_going: "Keep practicing!",
      ...
      all_pairs_correct: "All pairs are correct!",
      some_wrong: "Some associations are incorrect.",
      reorder: "Put in the correct order:",
      correct_order: "Correct order: {{order}}",
      place_labels: "Place the labels:",
    },
    probleme: {
      default_title: "Problem",
      questions_header: "Questions",
      validate_see: "Validate and see solution",
      did_you_know: "Did you know it?",
      i_knew: "✅ I knew it",
      i_knew_partly: "😅 I kind of knew it",
      i_didnt_know: "❌ I didn't know it",
      saved: "Answer saved.",
    },
    dictee: {
      start: "Start the dictation",
      pause: "Pause",
      resume: "Resume",
      finished: "I'm done",
      paused_label: "Dictation paused",
      listening_label: "Listen and write — don't look at the text",
    },
    progress: {
      ...
      to_retry: "To retry",
      retry: "Retry",
      retry_prompt: "Give me exercises on",
    },
    intent_chips: {
      button_label: "Activities",
      exercice: { label: "Exercises", template: "Give me exercises on " },
      fiche: { label: "Study sheet", template: "Make me a study sheet on " },
      carte_mentale: { label: "Mind map", template: "Make me a mind map on " },
      cours: { label: "Full lesson", template: "Give me a full lesson on " },
      video: { label: "Video", template: "Make me a pedagogical video on " },
      explication: { label: "Explanation", template: "Explain " },
      exemple: { label: "Examples", template: "Give me concrete examples of " },
      dictee: { label: "Dictation", template: "Make me a dictation" },
      brevet: { label: "Mock brevet", template: "Give me a mock brevet exam" },
      coach_today: { label: "Today", template: "What should I do today?" },
      coach_bilan: { label: "My progress", template: "Give me an update on my progress" },
      coach_priorites: { label: "Priorities", template: "Which chapters should I work on first?" },
      coach_semaine: { label: "This week", template: "What is my plan for this week?" },
      coach_regularite: { label: "Consistency", template: "How is my study consistency going?" },
      coach_examen: { label: "Exam", template: "How long until the exam and where do I stand?" },
      coach_motive: { label: "Motivate me", template: "Encourage me, I need motivation" },
      coach_bloque: { label: "I'm stuck", template: "I'm stuck, help me get organized" },
    },
  },
};
