...
const TRANSLATIONS = {
  ...
  chat_window: {
    ...
    followup_chips: {
      ...
      coach_encore: { label: "Encore", template: "Continue, motive-moi" },
      coach_action: { label: "Action", template: "Quelle est ma prochaine action concrète ?" },
    },
    fork: "Dupliquer",
    delete: "Supprimer",
    cancel: "Annuler",
  ...
  sara: {
    quiz: {
      ...
      wrong_answer: "Réponse correcte : {{answer}}",
      wrong_vf: "Réponse : {{answer}}",
      placeholder_short: "Réponse courte...",
      placeholder_write: "Écris ta réponse ici…",
      i_knew: "Je savais !",
      well_done: "Bien joué !",
      keep_revising: "Continue à réviser !",
      score_perfect: "Parfait !",
      score_good: "Bien joué !",
      score_keep_going: "Continue à t'entraîner !",
      score_label: "Score : {{correct}} / {{total}} — {{msg}}",
      true: "Vrai",
      false: "Faux",
      to_review: "À revoir",
      click_to_flip: "Cliquer pour retourner",
      match_pairs: "Associe les paires :",
      all_pairs_correct: "Toutes les paires sont correctes !",
      some_wrong: "Certaines associations sont incorrectes.",
      reorder: "Remets dans le bon ordre :",
      correct_order: "Ordre correct : {{order}}",
      place_labels: "Place les étiquettes :",
    },
    probleme: {
      default_title: "Problème",
      questions_header: "Questions",
      validate_see: "Valider et voir le corrigé",
      did_you_know: "Tu avais trouvé ?",
      i_knew: "✅ Je savais",
      i_knew_partly: "😅 Je savais plus ou moins",
      i_didnt_know: "❌ Je ne savais pas",
    ...
    dictee: {
      ...
      resume: "Reprendre",
      finished: "J'ai fini",
      paused_label: "Dictée en pause",
      listening_label: "Écoute et écris — ne regarde pas le texte",
    },
    progress: {
      button_title: "Voir ma progression",
      empty: "Aucun quiz complété dans ce chapitre.",
      to_retry: "À retravailler",
      retry: "Retravailler",
      retry_prompt: "Donne-moi des exercices sur",
    },
    intent_chips: {
      button_label: "Activités",
      exercice: { label: "Exercices", template: "Donne-moi des exercices sur " },
      fiche: { label: "Fiche de révision", template: "Fais-moi une fiche de révision sur " },
      carte_mentale: { label: "Carte mentale", template: "Fais-moi une carte mentale sur " },
      cours: { label: "Cours complet", template: "Fais-moi un cours complet sur " },
      video: { label: "Vidéo", template: "Fais-moi une vidéo pédagogique sur " },
      explication: { label: "Explication", template: "Explique-moi " },
      exemple: { label: "Exemples", template: "Donne-moi des exemples concrets de " },
      dictee: { label: "Dictée", template: "Fais-moi une dictée" },
      brevet: { label: "Brevet blanc", template: "Donne-moi un sujet de brevet blanc" },
      coach_today: { label: "Aujourd'hui", template: "Qu'est-ce que je dois faire aujourd'hui ?" },
      coach_bilan: { label: "Mon bilan", template: "Fais le point sur ma progression" },
      coach_priorites: { label: "Priorités", template: "Quels chapitres je dois travailler en priorité ?" },
      coach_semaine: { label: "Cette semaine", template: "Quel est mon plan pour cette semaine ?" },
      coach_regularite: { label: "Ma régularité", template: "Comment va ma régularité de travail ?" },
      coach_examen: { label: "Examen", template: "Combien de temps avant l'examen et où en suis-je ?" },
      coach_motive: { label: "Motive-moi", template: "Encourage-moi, j'ai besoin de motivation" },
      coach_bloque: { label: "Je bloque", template: "Je suis bloqué, aide-moi à m'organiser" },
    },
  },
};
