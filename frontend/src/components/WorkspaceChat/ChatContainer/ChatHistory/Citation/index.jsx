...
export default function Citations({ sources = [] }) {
  ...
  return (
    <button
      ...
      className="w-fit flex items-center gap-[6px] px-[10px] py-[5px] rounded-full border border-[rgba(74,222,128,0.35)] light:border-[rgba(17,140,68,0.3)] bg-[rgba(17,140,68,0.12)] light:bg-[rgba(17,140,68,0.08)] hover:bg-[rgba(17,140,68,0.2)] light:hover:bg-[rgba(17,140,68,0.14)] transition-colors"
      type="button"
    >
      <span className="text-xs font-medium text-emerald-100 light:text-emerald-900">
