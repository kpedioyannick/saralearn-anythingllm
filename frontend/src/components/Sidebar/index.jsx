...
export default function Sidebar() {
  ...
  const wasNarrowScreen = useRef(window.innerWidth <= 1024);
  ...
  useEffect(() => {
    function handleResize() {
      ...
      // On narrow screens/tablets, always close sidebar.
      if (isNarrowScreen) {
        setShowSidebar(false);
      } else if (wasNarrowScreen.current) {
        // When returning from narrow -> wide, always reopen the sidebar.
        setShowSidebar(true);
      }

      wasNarrowScreen.current = isNarrowScreen;
    }
          ...
          >
            <div className="flex flex-col h-full overflow-hidden">
              <div className="flex-grow flex flex-col min-w-[235px] min-h-0">
                <div className="relative h-[calc(100%-60px)] flex flex-col w-full justify-between pt-[10px] overflow-y-scroll show-scrollbar sidebar-scrollbar">
...
export function SidebarMobileHeader() {
  ...
  useEffect(() => {
    function handleResize() {
      // Keep drawer closed while resizing to narrow layouts.
  ...
  useEffect(() => {
    // Close drawer on route changes (workspace/thread selection).
    setShowSidebar(false);
  }, [pathname]);
  ...
  return (
    <>
      ...
      >
        ...
        <div
          ref={sidebarRef}
          className="relative h-[100vh] fixed top-0 left-0 rounded-r-[26px] bg-theme-bg-sidebar w-[85%] max-w-[360px] p-[18px]"
        >
          <div className="w-full h-full flex flex-col overflow-x-hidden items-between">
            ...
            <div className="flex w-full items-center justify-between gap-x-4">
              ...
              <button
                type="button"
                onClick={() => setShowSidebar(false)}
                className="rounded-md p-2 text-theme-text-secondary hover:text-theme-text-primary"
